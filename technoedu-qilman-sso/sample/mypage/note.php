...
/**********************************************************************************************/
	...
	<div id="sub_top">
		<ul>
			...
			<li class="r2"><a href="./meeting_list.php">나의 회의</a><a href="./recording_list.php">녹화리스트</a><a href="./friend.php">친구</a><a href="./note.php" class="sub_select">쪽지</a><a href="./cash.php">캐시</a><span class="path">HOME > My FaceLink > 쪽지</span></li>
	...
	<section id="sub_section">
		<div id="mypage">
			...
			<section id="tab">
				...
				<label for="tab1" id="lab1">받은 쪽지함</label>
				<label for="tab2" id="lab2">보낸 쪽지함</label>
