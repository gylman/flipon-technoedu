		...
		<div id="join">
			...
			<div id="content1">		
				...
				<ul>
					...
					<li class="a"><input type="text"><input type="button" value="중복확인" class="btn_basic lightgray"></li>
				</ul>
				<ul>
					<li class="q">비밀번호 <span class="star">*</span> </li>
					<li class="a"><input type="password"></li>
				</ul>
				<ul>
				...
				<ul>
					...
					<li class="a"><input type="text" id="addr1"><input type="button" class="btn_basic lightgray" value="우편번호 검색"><BR><input type="text" id="addr2"></li>
				</ul>
			</div>
