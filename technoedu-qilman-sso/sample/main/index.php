...
<header id="header">
	<ul id="gnb">
		<li class="logo"><a href="../main/"><img src="../images/sub_logo.png"></a></li>
		<li class="main_gnb">
			<ul>
				<li><a href="#company"><img src="../images/gnb1.png"></a></li>
				<li><a href="../conference/reserve.php"><img src="../images/gnb2.png"></a></li>
				<li><a href="#products"><img src="../images/gnb3.png"></a></li>
				<li><a href="../contact/list.php"><img src="../images/gnb4.png"></a></li>
			</ul>
		</li>
		<li class="top_gnb">
			<ul>
				<!--<li><a href="../join/login.php"><img src="../images/med1.png"></a></li>-->	<!-- 로그인 -->
				<li><a href="#"><img src="../images/logout.png"></a></li>		<!-- 로그아웃 -->
				<li><a href="../join/join_step1.php"><img src="../images/med2.png"></a></li>
				<li><a href="../mypage/meeting_list.php"><img src="../images/med3.png"></a></li>
			</ul>
		</li>
	</ul>	
	<div class="banner">
		<ul class="banner-list">
			...
			<li class="list-2" style="display:none;"><img src="../images/banner2.jpg"></li>
			<li class="list-3" style="display:none;"><img src="../images/banner3.jpg"></li>
		</ul>
...
<section id="container">
	<div id="company">
		<div id="company_con">
			<ul id="pyo">
				<li class="r1">FACELINK</li>
				<li class="r2"><a href="../company/service.php" class="select_menu">서비스 소개</a><a href="../company/aboutus.php">회사소개</a><a href="../company/contact.php">Contact</a></li>
				<li class="r3">
					<p>“FACELINK는 언제 어디서나 우리를 하나로 이어줍니다.”</p>
					FACELINK는 HTML5기반 영상협업 솔루션으로 욱성미디어가 개발한 다자간 영상 협업 시스템을 통하여 다자간 영상회의, 다자간 영상 교육, 텔레프레즌스(Telepresence) 서비스를 PC, 타블렛, 스마트 폰의 HTML5를 지원하는 웹 브라우저에서 아무런 플러그인 설치 없이 지원합니다. 또한 기존 표준 영상회의 장비와 호환 가능한 제품으로 고화질의 영상과 고품질의 음성으로 언제, 어디서나 영상 협업이 가능합니다. . FACELINK는 여러분들이  회의시 필요한 시간과 비용을 줄여드리고, 업무와 교육에 있어서 생산성과 효율성 증대에 많은 도움을 줄 것입니다.
				</li>				
			</ul>
			<div id="pyo_img"><img src="../images/facelink1.png"></div>
		</div>
	</div>
	<ul id="products">
		<li>
			<ul id="pyo">
				...
				<li class="r2"><a class="select_menu">화상회의소개</a><a id="3-2">화상단말기소개</a></li>
				<li class="r3">
					<p>"HTML5 Based Video Presence Service"</p>
					오늘날 정보통신산업의 비약적인 발전에 따라 네트워크에 연결하여 사용할 수 있는 기기들이 
					PC뿐 아니라 스마트 패드, 스마트 폰, DID, 스마트 카 등으로 여러 종류의 제품들이 출시되고 
					있습니다. 이러한 기기들을 하나의 협업 시스템으로 묶어서 동작 시키기에는 사용자가 일일이 
					어플리케이션을 설치하고 세팅을 해야 하는 등의 불편함과 사용하기 까지 의 시간이 오래 
					걸리는 문제가 있습니다.<BR>
					욱성미디어의 FACELINK 서비스는 HTML5 기반의 환경에서 동작할 수 있는 환경을 제공하여 
					이러한 문제점들을 해결하는 차세대 영상 협업 서비스입니다. FACELINK 서비스는 HTML5
					기반의 환경에서 실행되어 플러그인 프로그램이나 기타 어플리케이션이 필요하지 않고 현재 
					나와 있는 수 많은 스마트 디바이스 환경을 지원합니다.<BR> 
					또한 웹 환경의 서비스를 통하여 가장 간편하고 신속하게 협업 공간을 만들고 사람들을 연결하여 
					영상 회의 및 협업 작업을 진행 할 수 있으며 기존 영상회의 시스템과도 연결이 가능합니다.
					FACELINK 제품은 기업, 관공서, 학교 등에서 스마트워크, 다자간 회의, 스마트 교육등에 
					활용될 수 있으며 이 외에 다양한 분야에 활용할 수 있습니다. 이제 여러분들은 FACELINK를 
					활용하여 다양한 분야에서 여러 사람들과 온라인으로 쉽고 빠르게 만날 수 있습니다. 
					지금 바로 가입하여 편리함을 누려 보세요.
				</li>				
			</ul>
		...
		<li>
			<ul id="pyo">
				<li class="r1">PRODUCTS</li>
				<li class="r2"><a id="3-1">화상회의소개</a><a class="select_menu">화상단말기소개</a></li>
				<li class="r3">							
					<p>"model name : iMentor WEB-100"</p>
...
<footer id="footer">
	<ul>
		...
		<li id="notice">
			...
			<ul>
				<li class="subject">FACELINK 홈페이지를 오픈합니다.</li><li class="date">2014.11.12</li>
			</ul>
			<ul class="notice">
				<li class="subject">FACELINK 홈페이지를 오픈합니다.</li><li class="date">2014.11.12</li>
			</ul>
	...
	<p> COPYRIGHT(C) FACELINK CO., LTD. ALL RIGHTS RESERVED.</p>
</footer>
</body>
