...
<link rel="stylesheet" type="text/css" href="../css/meeting_layout_mobile.css?v=1227">
...
<script type='text/javascript' src="room_comm.js?v=4"></script>
<?
...
?>
		...
		<div class="left_area">
			<div id="movie">
					<div id="divVideo" class='div-video'>
						<div id="divVideoRemote" style='height:auto; width:100%'>
							<video class="video" width="100%" height="auto" id="video_remote" autoplay style="opacity: 255; 
			...
			<div id="movie_option">
				...
				<a href="#" id="btn_camswitch" class="option8"><img src="../images/switch_cam.png"></a>
	...
	<br>
<div class="vertical-line" style="height: 30px;" ><b>문서 공유 및 화이트보드</b></div>
		<!-- 문서 및 화이트보드 -->
