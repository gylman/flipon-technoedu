...
$(document).ready(function() {
	//기본 선택 설정
	var tab_num = localStorage.getItem("com.facelink.mypage.friend_tap");
	if(tab_num == "1"){
		$("#tab1").trigger("click");
		localStorage.removeItem("com.facelink.mypage.friend_tap");
	}else if(tab_num == "2"){
		$("#tab2").trigger("click");
		localStorage.removeItem("com.facelink.mypage.friend_tap");
	}else if(tab_num == "3"){
	...
	<div id="sub_top">
		<ul>
			...
			<li class="r2"><a href="./meeting_list.php">나의 회의</a><a href="./recording_list.php">지난회의목록</a><a href="./friend.php" class="sub_select">친구</a><a href="./note.php">쪽지</a><a href="../join/join_edit.php">회원정보</a><a href="./device_test.php">장치설정</a><span class="path">HOME > My i-Mentor> 친구</span></li>
	...
	<section id="sub_section">
		<div id="mypage">
			...
			<section id="tab">
				...
				<label for="tab3" id="lab3">신청 메시지 관리(<span id="invite_msg_cnt">0</span>)</label>
