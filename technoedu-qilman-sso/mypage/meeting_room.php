...
$(document).ready(function() {
	...
	$('#btn_mute_sound').click(function(e) {
		if (!bIsAudioMute) {
	        ...
	        $.post('../mcutest/mcucomm.php', {cmd: 'setAudioMute', uid: g_uid, partId: g_user_id+'@technoedu.co.kr', flag: 1} );
		} else {
			//$.post('../mcutest/mcucomm.php', {cmd: 'setAudioMute', uid: g_uid, partId: g_user_id+'@mentorservice.co.kr', flag: 0} );
			$.post('../mcutest/mcucomm.php', {cmd: 'setAudioMute', uid: g_uid, partId: g_user_id+'@technoedu.co.kr', flag: 0} );
		}
	...
	$('#btn_mute_video').click(function(e) {
		if (!bIsVideoMute) {
	        ...
	        $.post('../mcutest/mcucomm.php', {cmd: 'setVideoMute', uid: g_uid, partId: g_user_id+'@technoedu.co.kr', flag: 1} );
		} else {
			//$.post('../mcutest/mcucomm.php', {cmd: 'setVideoMute', uid: g_uid, partId: g_user_id+'@mentorservice.co.kr', flag: 0} );
			$.post('../mcutest/mcucomm.php', {cmd: 'setVideoMute', uid: g_uid, partId: g_user_id+'@technoedu.co.kr', flag: 0} );
		}
