...
$(document).ready(function() {
	...
	if(g_type == "notice" || g_type == "footer"){
		api = "board_notice_read.php";
		title = "공지사항";
		$("#notice_a").attr("class","sub_select");
	}
	else if(g_type == "faq"){
		api = "board_faq_read.php";
		title = "FAQ";
		$("#faq_a").attr("class","sub_select");
	}
	...
	$.post( g_apiUrlRoot+api, postJsonData, function( dataJson) {
		...
		if (dataJson.rt_code == 0) {
			...
			$("#user_name").text(dataJson.user_id);
	...
	<div id="sub_top">
		<ul>
			...
			<li class="r2"><a id="notice_a" href="notice_list.php">공지사항</a><a href="qna_write.php">문의사항</a><a id="faq_a" href="faq_list.php">FAQ</a><span class="path">HOME > FaceLink 고객센터 > </span></li>
			<li class="r3"></li>
		</ul>		
	</div>
