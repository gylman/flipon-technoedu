...
function setList(now_page, now_limit){
	...
	$.post( g_apiUrlRoot+"board_faq_list.php", postJsonData, function( dataJson) {
...
$(document).ready(function() {
	$("#common_room_list").on("click", "ul~ul[name=board]", function(){
		...
		localStorage.setItem("com.facelink.contack.faq_list.page_num",g_now_page)
		localStorage.setItem("com.facelink.contack.faq_list.search_val", g_search_val);
		
		location.href = "./content.php?type=faq&bid=" + $(this).children(".col1").data("bid");
	});
	...
	//기본 선택 설정
	g_now_page = localStorage.getItem("com.facelink.contack.faq_list.page_num");
	g_search_val = localStorage.getItem("com.facelink.contack.faq_list.search_val");
	if(g_now_page != null){
		localStorage.removeItem("com.facelink.contack.faq_list.page_num");
		localStorage.removeItem("com.facelink.contack.faq_list.search_val");
	}else{
		g_now_page = 0;
		g_search_val = '';
	}
	...
	<div id="sub_top">
		<ul>
			...
			<li class="r2"><a href="notice_list.php">공지사항</a><a href="qna_write.php">문의사항</a><a href="faq_list.php" class="sub_select">FAQ</a><span class="path">HOME > FaceLink 고객센터 > FAQ</span></li>
			<li class="r3"><span>FAQ</span></li>
		</ul>		
	</div>
