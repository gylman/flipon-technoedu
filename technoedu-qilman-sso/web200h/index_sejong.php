		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0331000" onclick='connecttomcu("0331000",serverip);'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0332000" onclick='connecttomcu("0332000",serverip);'></li>
                            <li><input type="button" value="3 번" class="button big special" id="bt_0333000" onclick='connecttomcu("0333000",serverip);'></li>
				    	</ul>
					    <ul class="actions">
                            <li><input type="button" value="4 번" class="button big special" id="bt_0334000" onclick='connecttomcu("0334000",serverip);'></li>
                            <li><input type="button" value="테스트" class="button big special" id="bt_0335000" onclick='connecttomcu("0335000",serverip);'></li>
...
var roomList = ["0331000", "0332000", "0333000", "0334000", "0335000" ];
