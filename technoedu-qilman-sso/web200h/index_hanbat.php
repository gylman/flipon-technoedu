		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="ROOM 1" class="button big special" id="bt_0391000" onclick='connecttomcu("0391000",serverip);'></li>
                            <li><input type="button" value="ROOM 2" class="button big special" id="bt_0392000" onclick='connecttomcu("0392000",serverip);'></li>
                            <!--
                            <li><input type="button" value="박준병 교수님" class="button big special" id="bt_0393000" onclick='connecttomcu("0393000");'></li>
                        -->
                            <li><input type="button" value="TEST" class="button big special" id="bt_0394000" onclick='connecttomcu("0394000",serverip);'></li>
				    	</ul>
					</form>
				</div>
			</section>
...
var roomList = ["0391000", "0392000", "0393000", "0394000"];
var roomNameList = ["ROOM 1", "ROOM 2", "박준병 교수님", "TEST"];
// get room uid
