	...
	<body id="top">
		...
		<!-- Header -->
			<header id="header" class="skel-layers-fixed">
				...
				<nav id="nav">
					<ul>
						<li><a href="index_jacklist_jpn.php">日本語</a></li>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0411000" onclick='connecttomcu("0411000",serverip);'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0412000" onclick='connecttomcu("0412000",serverip);'></li>
                            <li><input type="button" value="3 번" class="button big special" id="bt_0413000" onclick='connecttomcu("0413000",serverip);'></li>
				    	</ul>
					    <ul class="actions">
                            <li><input type="button" value="테스트" class="button big special" id="bt_0414000" onclick='connecttomcu("0414000",serverip);'></li>
