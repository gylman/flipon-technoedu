		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0741000" onclick='connecttomcu("0741000",serverip);'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0742000" onclick='connecttomcu("0742000",serverip);'></li>
                            <li><input type="button" value="HOME" class="button big special" onclick="location.href='http://biz-strategy.co.kr'"></li>
					    </ul>
					</form>
				</div>
			</section>
