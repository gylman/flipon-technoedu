		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="화상회의방" class="button big special" id="bt_0281100" onclick='connecttomcu("0281100",serverip);'></li>
					    </ul>
					</form>
				</div>
			</section>
...
var roomList = ["0281100"];
var roomNameList = ["화상회의방"];
// get room uid
