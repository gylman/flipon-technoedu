		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0451000" onclick='connecttomcu("0451000",serverip);'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0452000" onclick='connecttomcu("0452000",serverip);'></li>
                            <li><input type="button" value="3 번" class="button big special" id="bt_0453000" onclick='connecttomcu("0453000",serverip);'></li>
				    	</ul>
					    <ul class="actions">
                            <li><input type="button" value="테스트" class="button big special" id="bt_0454000" onclick='connecttomcu("0454000",serverip);'></li>
