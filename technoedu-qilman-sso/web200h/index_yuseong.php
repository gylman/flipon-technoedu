		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0521000" onclick='connecttomcu("0521000",serverip);'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0522000" onclick='connecttomcu("0522000",serverip);'></li>
                            <li><input type="button" value="3 번" class="button big special" id="bt_0523000" onclick='connecttomcu("0523000",serverip);'></li>
				    	</ul>
					    <ul class="actions">
                            <li><input type="button" value="테스트" class="button big special" id="bt_0524000" onclick='connecttomcu("0524000",serverip);'></li>
                            <li><input type="button" value="YOUTUBE" class="button big special" onclick="location.href='https://youtube.com'"></li>
					    </ul>
					</form>
				</div>
			</section>
...
var roomList = ["0521000", "0522000", "0523000", "0524000"];
var roomNameList = ["1 번", "2 번", "3 번", "테스트"];
// get room uid
