		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0381000" onclick='connecttomcu("0381000",serverip);'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0382000" onclick='connecttomcu("0382000",serverip);'></li>
                            <li><input type="button" value="3 번" class="button big special" id="bt_0383000" onclick='connecttomcu("0383000",serverip);'></li>
				    	</ul>
					    <ul class="actions">
                            <li><input type="button" value="4 번" class="button big special" id="bt_0384000" onclick='connecttomcu("0384000",serverip);'></li>
                            <li><input type="button" value="5 번" class="button big special" id="bt_0385000" onclick='connecttomcu("0385000",serverip);'></li>
                            <li><input type="button" value="6 번" class="button big special" id="bt_0386000" onclick='connecttomcu("0386000",serverip);'></li>
				    	</ul>
					    <ul class="actions">
                            <li><input type="button" value="7 번" class="button big special" id="bt_0387000" onclick='connecttomcu("0387000",serverip);'></li>
                            <li><input type="button" value="테스트" class="button big special" id="bt_0388000" onclick='connecttomcu("0388000",serverip);'></li>
                            <li><input type="button" value="HOME" class="button big special" onclick="location.href='https://www.livedu.co'"></li>
					    </ul>
					</form>
				</div>
			</section>
...
var roomList = ["0381000", "0382000", "0383000", "0384000", "0385000", "0386000", "0387000", "0388000"];
var roomNameList = ["1 번", "2 번", "3 번", "4 번", "5 번", "6 번", "7 번", "테스트"];
// get room uid
