		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="ROOM 1" class="button big special" id="bt_0431000" onclick='connecttomcu("0431000");'></li>
                            <li><input type="button" value="ROOM 2" class="button big special" id="bt_0432000" onclick='connecttomcu("0432000");'></li>
                            <li><input type="button" value="ROOM 3" class="button big special" id="bt_0433000" onclick='connecttomcu("0433000");'></li>
				    	</ul>
					    <ul class="actions">
                            <li><input type="button" value="TEST 1" class="button big special" id="bt_0434000" onclick='connecttomcu("0434000");'></li>
                            <li><input type="button" value="TEST 2" class="button big special" id="bt_0435000" onclick='connecttomcu("0435000");'></li>
					    </ul>
					</form>
				</div>
			</section>
...
function updateRoom() {
    $.post('./mcucomm/mcucomm_115_146_127_8.php', {cmd: 'GetConfList'} )
        .done(
                function ( data ) {
                    val = eval('(' + data + ')');
                    if ( val == null ) {
