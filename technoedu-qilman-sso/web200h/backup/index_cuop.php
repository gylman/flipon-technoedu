		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0301000" onclick='connecttomcu("0301000");'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0302000" onclick='connecttomcu("0302000");'></li>
                            <li><input type="button" value="3 번" class="button big special" id="bt_0303000" onclick='connecttomcu("0303000");'></li>
					    </ul>
					    <ul class="actions">
                            <li><input type="button" value="4 번" class="button big special" id="bt_0301000" onclick='connecttomcu("0304000");'></li>
                            <li><input type="button" value="5 번" class="button big special" id="bt_0302000" onclick='connecttomcu("0305000");'></li>
                            <li><input type="button" value="6 번" class="button big special" id="bt_0303000" onclick='connecttomcu("0306000");'></li>
					    </ul>
					    <ul class="actions">
                            <li><input type="button" value="7 번" class="button big special" id="bt_0301000" onclick='connecttomcu("0307000");'></li>
                            <li><input type="button" value="8 번" class="button big special" id="bt_0302000" onclick='connecttomcu("0308000");'></li>
                            <li><input type="button" value="9 번" class="button big special" id="bt_0303000" onclick='connecttomcu("0309000");'></li>
					    </ul>
					</form>
				</div>
			</section>
...
var roomNameList = ["1 번", "2 번", "3 번", "4 번", "5 번", "6 번", "7 번", "8 번", "9 번"];
// get room uid
