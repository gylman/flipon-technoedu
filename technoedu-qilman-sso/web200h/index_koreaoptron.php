		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0561000" onclick='connecttomcu("0561000");'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0562000" onclick='connecttomcu("0562000");'></li>
                            <li><input type="button" value="HOME" class="button big special" onclick="location.href='http://www.koreaoptron.co.kr'"></li>
					    </ul>
					</form>
				</div>
			</section>
...
var roomList = ["0561000", "0562000"];
var roomNameList = ["1 번", "2 번"];
// get room uid

function updateRoom() {
    $.post('./mcucomm/mcucomm_115_68_14_58.php', {cmd: 'GetConfList'} )
        .done(
                function ( data ) {
                    val = eval('(' + data + ')');
                    if ( val == null ) {
