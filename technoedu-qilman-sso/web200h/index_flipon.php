			...
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    ...
					    <ul class="actions">
                            <li><input type="button" value="테스트1" class="button big special" id="bt_0384000" onclick='connecttomcu("0384000",serverip);'></li>
                            <li><input type="button" value="테스트2" class="button big special" id="bt_0385000" onclick='connecttomcu("0385000",serverip);'></li>
...
var roomNameList = ["1 번", "2 번", "3 번", "테스트1", "테스트2"];
// get room uid
