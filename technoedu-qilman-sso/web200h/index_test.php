	<head>
		...
		<meta http-e uiv="content-type" content="text/html; charset=utf-8" />
	...
	<body id="top">
		...
		<!-- Header -->
			<header id="header" class="skel-layers-fixed">
				...
				<nav id="nav">
					<ul>
						<li><a href="javascript:logout();" class="button special">로그아웃</a></li>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0321000" onclick='connecttomcu("0321000",serverip);'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0322000" onclick='connecttomcu("0322000",serverip);'></li>
                            <li><input type="button" value="3 번" class="button big special" id="bt_0323000" onclick='connecttomcu("0323000",serverip);'></li>
				    	</ul>
					    <ul class="actions">
