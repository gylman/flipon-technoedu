		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="메인회의방" class="button big special" id="bt_0280000" onclick='connecttomcu("0280000",serverip);'></li>
                            <li><input type="button" value="보조회의방" class="button big special" id="bt_0280001" onclick='connecttomcu("0280001",serverip);'></li>
					    </ul>
					</form>
				</div>
			</section>
