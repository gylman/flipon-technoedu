		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="메인회의방" class="button big special" id="bt_0280200" onclick='connecttomcu("0280200",serverip);'></li>
                            <li><input type="button" value="보조회의방" class="button big special" id="bt_0280201" onclick='connecttomcu("0280201",serverip);'></li>
					    </ul>
					</form>
				</div>
			</section>
...
var roomList = ["0280200", "0280201"];
var roomNameList = ["메인회의방", "보조회의방"];
// get room uid
