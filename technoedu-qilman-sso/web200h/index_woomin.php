		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_14221001" onclick='connecttomcu("14221001",serverip);'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_14221002" onclick='connecttomcu("14221002",serverip);'></li>
					    </ul>
					</form>
				</div>
			</section>
...
var roomList = ["14221001", "14221002"];
