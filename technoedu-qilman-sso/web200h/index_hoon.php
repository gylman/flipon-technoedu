	<head>
		...
		<t2021eta name="description" content="" />
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0841000" onclick='connecttomcu("0841000",serverip);'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0842000" onclick='connecttomcu("0842000",serverip);'></li>
					    </ul>
					</form>
				</div>
			</section>
