		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="1 번" class="button big special" id="bt_0671000" onclick='connecttomcu("0671000",serverip);'></li>
                            <li><input type="button" value="2 번" class="button big special" id="bt_0672000" onclick='connecttomcu("0672000",serverip);'></li>
                            <li><input type="button" value="HOME" class="button big special" onclick="location.href='http://www.apexint.co.kr'"></li>
					    </ul>
					</form>
				</div>
			</section>
