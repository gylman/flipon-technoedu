		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<form name="formcall">
					    <ul class="actions">
                            <li><input type="button" value="메인회의방" class="button big special" id="bt_0280100" onclick='connecttomcu("0280100",serverip);'></li>
                            <li><input type="button" value="보조회의방" class="button big special" id="bt_0280101" onclick='connecttomcu("0280101",serverip);'></li>
					    </ul>
					</form>
				</div>
			</section>
