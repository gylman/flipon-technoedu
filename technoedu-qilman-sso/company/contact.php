...
#contact > ul > li > span { display:inline; padding:2px 10px; margin-right:10px; background:#383838; color:#ffffff; border-radius:5px; border:1px solid #302f2f; }
	...
	<div id="sub_top">
		<ul>
			...
			<li class="r2"><a href="./service.php">서비스 소개</a><a href="./aboutus.php">회사소개</a><a href="./contact.php" class="sub_select">Contact</a><span class="path">HOME > i-MentorService > Contact</span></li>
