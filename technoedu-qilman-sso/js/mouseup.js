$('#movie').mouseup(function(e){
    ...
    switch(mcuCompType)
    {
        ...
        if(moveXup < TwohalfWidth && moveYup < TwohalfWidth)
        {
                setChangePos(num,val.slotlist[0].partid);
                setChangePos(0,val.slotlist[num].partid);
        }
        ...
        else if(moveXup > OnehalfWidth-One_onehalfWidth && moveXup < OnehalfWidth && moveYup > ThreehalfHeight*3)
        {
            if(num > 1)
            {
                setChangePos(5,val.slotlist[num].partid);
        ...
        else if(moveXup > OnehalfWidth && moveXup < OnehalfWidth+One_onehalfWidth && moveYup > ThreehalfHeight*3)
        {
            if(num > 1)
            {
                setChangePos(6,val.slotlist[num].partid);
        ...
        if(moveXup < OnehalfWidth + One_onehalfWidth && moveYup < TwohalfHeight*2)
        {
                setChangePos(0,val.slotlist[num].partid);
                setChangePos(num,val.slotlist[0].partid);
        }
        ...
        else if(moveXup < OnehalfWidth-One_onehalfWidth && moveYup > TwohalfHeight*2)
        {
                if(num > 1)
                {
                    setChangePos(3,val.slotlist[num].partid);
        ...
        else if(moveXup > OnehalfWidth-One_onehalfWidth && moveXup < OnehalfWidth + One_onehalfWidth && moveYup > TwohalfHeight*2)
        {
                if(num > 1)
                {
                    setChangePos(4,val.slotlist[num].partid);
