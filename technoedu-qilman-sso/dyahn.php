...
<title>Dyahn i-Mentor Service</title>
...
<div id="wrap">
	<header id="header">
		<ul id="gnb">
			...
			<li class="main_gnb">
				<ul>
                    <!--
					<li><a href="../company/service.php"><img src="../images/gnb1.png"></a></li>
                    -->
			...
			<li class="top_gnb">
				<ul>
					<li class="login"><a href="../join/login_dyahn.php"><img src="../images/med1.png"></a></li>
    ...
    <!--?php include("../join/login_dyahn.php"); ?-->
    <meta http-equiv='refresh' content='0;url=../join/login_dyahn.php'>
</body>
