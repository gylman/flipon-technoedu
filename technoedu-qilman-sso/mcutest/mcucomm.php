<?
	...
	//$mcuurl = 'http://115.68.14.22:8585/wem1000/appsvrinf.jsp';
	//$mcuurl = 'http://49.247.9.66:8585/wem1000/appsvrinf.jsp';
	//$mcuurl = 'http://112.166.16.238:8585/wem1000/appsvrinf.jsp';

	$referer='';
    $mcuip='115.68.14.22';  // default value
    //$mcuip='121.159.74.222';  // default value
    //$mcuip='';  // default value
    ...
    function console_log($log){
        echo " <script>console.log('PHP_Console:'.$log);</script>";
    }

    // sykim 2021.8.9
    if(strpos($data, "mcuip") !== false) {
        $mcuip=explode('&',$data);

        $mcuurl = substr($mcuip[0],6);   //parsing POST data
    } else {
        $mcuurl = $mcuip;
    }

    $mcuurl = 'http://' .$mcuurl. ':8585/wem1000/appsvrinf.jsp'; //make mcuurl
