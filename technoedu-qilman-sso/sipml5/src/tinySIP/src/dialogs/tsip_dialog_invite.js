...
tsip_dialog_invite.prototype.new_msession_mgr = function(e_type, s_addr, b_ipv6, b_offerer){
    ...
    o_msession_mgr.set(
            ...
            tmedia_session_mgr.prototype.SetParamSession(o_msession_mgr.e_type, "audio-src-id", this.get_stack().media.o_audio_src_id), /* add by scchoi*/
            tmedia_session_mgr.prototype.SetParamSession(o_msession_mgr.e_type, "video-src-id", this.get_stack().media.o_video_src_id)
