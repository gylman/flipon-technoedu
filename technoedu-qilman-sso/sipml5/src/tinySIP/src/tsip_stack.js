...
function tsip_stack(s_realm, s_impi, s_impu_uri, s_proxy_cscf_host, i_proxy_cscf_port) {
    ...
    this.media.audio_src_id = null;
    this.media.video_src_id = null;
...
/**
* Add by scchoi for Audio / Video Device Select
*/

tsip_stack.prototype.SetAudioSrcId = function (o_audio_src_id) {
    return tsip_stack.prototype.SetAny(tsip_stack_param_type_e.AUDIO_SOURCE_ID, o_audio_src_id);
}

tsip_stack.prototype.SetVideoSrcId = function (o_video_src_id) {
    return tsip_stack.prototype.SetAny(tsip_stack_param_type_e.VIDEO_SOURCE_ID, o_video_src_id);
}
...
tsip_stack.prototype.__set = function (ao_params) {
    ...
    for (var i = 0; i < ao_params.length; ++i) {
	    ...
	    /* add by scchoi */
            case tsip_stack_param_type_e.AUDIO_SOURCE_ID:
                {  
                    this.media.o_audio_src_id = o_curr.ao_values[0];
                    break;
                }

            case tsip_stack_param_type_e.VIDEO_SOURCE_ID:
                {  
                    this.media.o_video_src_id = o_curr.ao_values[0];
                    break;
                }
