...
SIPml.setStream_audio_view = null;
SIPml.setStream_video_view = null;
...
SIPml.Stack.prototype.setStreamUserGesture = function() {
		//SIPml.setStream_audio_view.play();
		//SIPml.setStream_video_view.play();
		//console.log(SIPml.setStream_audio_view);
		//console.log(SIPml.setStream_video_view);
}
...
SIPml.Stack.prototype.setConfiguration = function (o_conf) {
    ...
    var o_audio_src_id = o_conf.audio_src_id ? o_conf.audio_src_id : null; // add by scchoi
    var o_video_src_id = o_conf.video_src_id ? o_conf.video_src_id : null; // add by scchoi
    ...
    tsk_utils_log_info("o_video_src_id=" + o_video_src_id);
    ...
    o_stack.set(tsip_stack.prototype.SetPassword(o_conf.password),
                     ...
                     tsip_stack.prototype.SetAudioSrcId(o_audio_src_id),
                     tsip_stack.prototype.SetVideoSrcId(o_video_src_id)
		);
...
SIPml.Session.prototype.getLocalStream = function(){
	return this.o_session.get_stream_local();
}
